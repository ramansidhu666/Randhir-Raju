...
namespace Property_cls
{
    public class cls_Property
    {
        ...
        public int InsertDreamHouse(string Title, string filename, string Description, string Address, string Price,string logo,string Type)
        {
            int result = 0;
            try
            {
        ...
        public int InsertGallary(string Title, string ImageUrl)
        {
            int result = 0;
            try
            {
                ...
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandText = "usp_InsertGallary";
                cmd.Parameters.AddWithValue("@Title", Title);
        ...
        public DataTable GetDreamHouseList_Home(string type = "")
        {
            DataTable dt = new DataTable();
            try
            {
                ...
                cmd = new SqlCommand("usp_GetAllPreConstruction_Home", conn);
        ...
        public DataTable GetDreamHouseList(string type="")
        {
            DataTable dt = new DataTable();
            try
            {
                ...
                SqlCommand cmd = new SqlCommand();
                SqlDataAdapter da = new SqlDataAdapter();
                cmd = new SqlCommand("usp_GetAllPreConstruction", conn);
                cmd.Parameters.Add(new SqlParameter("@Type", type));
                cmd.CommandType = CommandType.StoredProcedure;
                da.SelectCommand = cmd;
                da.Fill(dt);
        ...
        public DataTable GetDreamHouse(string Type)
        {
            DataTable dt = new DataTable();
            try
            {
        ...
        public DataTable GetGallary()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand();
                SqlDataAdapter da = new SqlDataAdapter();
                cmd = new SqlCommand("usp_GetGallary", conn);
        ...
        public int DeleteDreamHouse(int id)
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "delete from tbl_PreConstructionImages where DreamHouseId=@id;";
                ...
                cmd1.CommandText = "delete from tbl_PreConstruction where id=@id;";
        ...
        public int DeleteGallary(int id)
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "delete from tbl_Gallary where id=@id;";
                cmd.Parameters.AddWithValue("@id", id);
                cmd.Connection = conn;
                if (conn.State == ConnectionState.Closed)
                {
        ...
        //end
        public DataTable GetGallaryByID(int id)
        {
            DataTable dt = new DataTable();
            try
            {
                ...
                string str = "select * from tbl_Gallary where id=" + id;
                SqlDataAdapter adp = new SqlDataAdapter(str, conn);
                adp.Fill(dt);
                dt.TableName = "tbl_Gallary";
            }
            catch (Exception ex)
            { }
            finally
