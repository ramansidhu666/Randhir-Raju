<%@ Page Title="" Language="C#" MasterPageFile="~/Property_New1.Master" AutoEventWireup="true" CodeBehind="DreamHouseDetail_SingleHomes.aspx.cs" Inherits="Property.DreamHouseDetail_SingleHomes" %>
...
<%@ Register TagName="DreamHouseDetailControl_SingleHome" TagPrefix="uc" Src="~/Controls/DreamHouseDetailControl_SingleHome.ascx" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="email_bg">
        <div class="Detail_Email">
            <uc:DreamHouseDetailControl_SingleHome ID="DreamHouseDetailControl_SingleHome" runat="server" />
        </div>
    </div>
