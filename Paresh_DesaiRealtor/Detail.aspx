      ...
      <div class="main_contnt_sct">
            <div class="Residential_section_bg" id="divresidential" runat="server" visible="false">
               ...
               <div class="col-md-3 col-sm-3"> 
                   <div class="Residential_section">
                    <div class="Residential_section_box">
                          <a href="../Search.aspx?Municipality=Kitchener" title="Kitchener">
                        <asp:HyperLink ID="hlresi2" runat="server">
                            <asp:Image ID="imgresi2" runat="server" />
                        </asp:HyperLink>
                         <asp:Label ID="resicity2" runat="server">Kitchener</asp:Label>
                               </a>
                    </div>
                </div> </div>
               <div class="col-md-3 col-sm-3"> 
                   <div class="Residential_section">
                   <div class="Residential_section_box">
                         <a href="../Search.aspx?Municipality=Waterloo" title="Waterloo">
                        <asp:HyperLink ID="hlresi3" runat="server">
                            <asp:Image ID="imgresi3" runat="server" />
                        </asp:HyperLink>
                         <asp:Label ID="resicity3" runat="server">Waterloo</asp:Label>
                              </a>
                    </div>
                </div> </div>
               <div class="col-md-3 col-sm-3"> 
                   <div class="Residential_section">
                    <div class="Residential_section_box">
                        <a href="../Search.aspx?Municipality=London" title="London">
                        <asp:HyperLink ID="hlresi4" runat="server">
                            <asp:Image ID="imgresi4" runat="server" />
                        </asp:HyperLink>
                           <asp:Label ID="resicity4" runat="server">London</asp:Label>
                             </a>
                    </div>
                </div> </div>
            </div>
            <div class="Residential_section_bg" id="divcommercial" runat="server" visible="false">
                ...
                <div class="Residential_section">
                    <div class="Residential_section_box">
                     ...
                     <asp:Label ID="commcity2" runat="server">Kitchener</asp:Label>
                               </a>
                    </div>
                </div>
                     </div>
                ...
                <div class="Residential_section">
                    <div class="Residential_section_box">
                      <a href="../Search.aspx?Municipality=Waterloo" title="Waterloo">
                       ...
                       <asp:Label ID="commcity3" runat="server">Waterloo</asp:Label>
                            </a>
                    </div>
                </div>
                     </div>
                ...
                <div class="Residential_section">
                    <div class="Residential_section_box">
                        ...
                        <asp:Label ID="commcity4" runat="server">London</asp:Label>
                    </div>
                </div>
                     </div>
            </div>
                ...
                <div class="Residential_section">
                    <div class="Residential_section_box">
                        ...
                        <asp:HyperLink ID="hlcon2" runat="server">
                         ...
                         <asp:Label ID="condocity2" runat="server">Kitchener</asp:Label></a>
                    </div>
                </div>
                     </div>
                 <div class="col-md-3 col-sm-3">
                <div class="Residential_section">
                    <div class="Residential_section_box">
                        ...
                        <asp:HyperLink ID="hlcon3" runat="server">
                         ...
                         <asp:Label ID="condocity3" runat="server">Waterloo</asp:Label></a>
                    </div>
                </div>
                     </div>
                 <div class="col-md-3 col-sm-3">
                <div class="Residential_section">
                    <div class="Residential_section_box">
                        <a href="../Search.aspx?Municipality=London" title="London">
                             ...
                             <asp:Label ID="condocity4" runat="server">London</asp:Label></a>
                    </div>
                </div>
                     </div>
            </div>
