                                ...
                                <div class="boxx_construction">
                                    ...
                                    <div class="construction_bg">
                                        ...
                                        <div class="text_bg_bottom mrgn_btn">
                                            <% if (Request.QueryString["Type"].ToString() == "Family_home")
                                               { %>
                                            <asp:HyperLink ID="HyperLink2" NavigateUrl='<%# Eval("Id", "~/DreamHouseDetail_SingleHomes.aspx?ID={0}") %>' CssClass="read_more_btn3" Text="Read More" runat="server"></asp:HyperLink>
                                        ...
                                        <div class="text_bg_bottom">
                                            <asp:HyperLink ID="HyperLink1" NavigateUrl='<%# Eval("Id", "~/Register.aspx?ID={0}&Type=" + Request.QueryString["Type"].ToString()) %>' CssClass="btn btn-primary cond_detail_btn" Text="Yes,Email me more info" runat="server"></asp:HyperLink>
                                        </div>
