...
{
    public partial class DreamHouseDetailControl_SingleHome : System.Web.UI.UserControl
    {
        #region PageLoad
        ...
        public void SendMailToAdmin(string UserEmailId,string ProjectName)
        {
            ...
            body = body + "<p>Project Name : " + ProjectName + "</p>";
            mail.Body = body;
        ...
        public void SendMailToUser(string UserEmailId)
        {
            ...
            mail.To.Add(ToEmailID);
            mail.From = new MailAddress(FromEmailID);
            mail.Subject = "Randhir Dhaliwal & Gurwinder";
            string body = "";
