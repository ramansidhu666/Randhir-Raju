<%@ Page  Title="" Language="C#" ValidateRequest="false" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true"  CodeBehind="SimpleFamilyHome.aspx.cs" Inherits="Property.Admin.SimpleFamilyHome" %>
                ...
                <div class="module-body">
                    <div class="form-horizontal row-fluid">
                         ...
                         <div class="control-group">
                            ...
                            <div class="controls">
                                <asp:FileUpload ID="FileUpload1" CssClass="multi" AllowMultiple="false" runat="server" />
                                <span class="help-inline">
                                    <asp:Image ID="ImgLogo" Width="130px"  runat="server" Visible="false" /></span>
                        ...
                        <asp:GridView ID="grdBannerShow" class="table table-striped table-bordered table-condensed" AutoGenerateColumns="False" OnRowCommand="GrdBlogList_RowCommand" PageSize="10" runat="server">
                            <Columns>
                               <%-- <asp:BoundField DataField="ID" HeaderText="#" SortExpression="ID"></asp:BoundField>--%>
                                 <asp:TemplateField HeaderText="Logo" SortExpression="ID">
                                    <ItemTemplate>
                                        <img src='/admin/Single_homes_logo/<%#Eval("logo") %>' alt="" width="100px" height="100px" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Image" SortExpression="ID">
                                    <ItemTemplate>
                                        <img src='/admin/Single_homes/<%#Eval("ImageUrl") %>' alt="" width="100px" height="100px" />
                                    </ItemTemplate>
                                </asp:TemplateField>
