...
{
    public partial class InvestedProperties : System.Web.UI.Page
    {
        #region Global
        ...
        protected void FillGridData()
        {
            try
            {
                ...
                dt = clsobj.GetDreamHouse("InvestedProperties");
        ...
        protected void GrdBlogList_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            else if (e.CommandName == "Editrec")
            {
                ...
                imgbanner.ImageUrl = "/admin/InvestedPropertiesUploadFiles/" + dt.Rows[0]["ImageUrl"].ToString();
        ...
        protected void btnUploadImage_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int DreamHouseId = clsobj.InsertDreamHouse(txtName.Text, fileNameForFirstImage, Server.HtmlEncode(txtDescription.Text), txtAddress.Text, txtPrice.Text, "", "InvestedProperties");
