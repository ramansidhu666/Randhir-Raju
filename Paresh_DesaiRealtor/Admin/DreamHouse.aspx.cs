    ...
    public partial class DreamHouse : System.Web.UI.Page
    {
        ...
        protected void FillGridData()
        {
            try
            {
                ...
                dt = clsobj.GetDreamHouse("Pre_cons");
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            if (FileUpload1.HasFile)
            {
                ...
                FileUpload1.PostedFile.SaveAs(Server.MapPath("Logo") + "\\" + fileName_logo);
        ...
        protected void btnUploadImage_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int DreamHouseId = clsobj.InsertDreamHouse(txtName.Text, fileNameForFirstImage, Server.HtmlEncode(txtDescription.Text), txtAddress.Text, txtPrice.Text, fileName_logo,"Pre_cons");
