    ...
    public partial class Detail : System.Web.UI.Page
    {
        ...
        void SearchResidentialProperties(string ptype)
        {
            try
            {
               ...
               // lblresi.Text = ptype + " Listings";
                    ...
                    hlresi2.NavigateUrl = "../PropertyType.aspx?Municipality=Kitchener&PropertyType=" + ptype;
                    //string s2 = dt.Rows[2]["RemarksForClients"].ToString();
                    
                    imgresi3.ImageUrl = "images/brampton.jpg" ;
                    hlresi3.NavigateUrl = "../PropertyType.aspx?Municipality=" + "Waterloo&PropertyType=" + ptype;
                    //string s3 = dt.Rows[3]["RemarksForClients"].ToString();
                     
                    imgresi4.ImageUrl = "images/markham.jpg";
                    hlresi4.NavigateUrl = "../PropertyType.aspx?Municipality=" + "London&PropertyType=" + ptype;
        ...
        void SearchCommercialProperties(string ptype)
        {
            try
            {
                ...
                imgresi2.ImageUrl = "images/Mississauga.jpg";
                hlresi2.NavigateUrl = "../Search.aspx?Municipality=Kitchener&PropertyType=" + ptype;
                //string s2 = dt.Rows[2]["RemarksForClients"].ToString();

                imgresi3.ImageUrl = "images/brampton.jpg";
                hlresi3.NavigateUrl = "../Search.aspx?Municipality=Waterloo&PropertyType=" + ptype;
                //string s3 = dt.Rows[3]["RemarksForClients"].ToString();

                imgresi4.ImageUrl = "images/markham.jpg";
                hlresi4.NavigateUrl = "../Search.aspx?Municipality=London&PropertyType=" + ptype;
